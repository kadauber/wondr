  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <select value={bi.axiom} onChange={e => this.handleChange(e, "axiom")}>
          {axioms.map((val, i) => (
        ...
        <Dots value={bi.level} onChange={e => this.handleChange(e, "level")} />
        <select
          value={bi.flavor}
        ...
        <br />
        {"flavorOptions" in flavor
          ? flavor.flavorOptions(bi, e => {
              this.handleChange({ target: { value: e } }, "flavorOptions");
            })
          : ""}
